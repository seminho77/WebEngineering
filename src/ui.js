...
export const renderBearData = async (bears) => {
    ...
    for (const bear of bears) {
        const imageUrl = await checkImageAvailability(bear.image !== '' ? bear.image : placeholderImage);
...
export const handleFormSubmission = () => {
    ...
    form.onsubmit = (event) => {
        ...
        const successMessage = new SpeechSynthesisUtterance('Comment submitted successfully!');
