...
import { toggleCommentsSection, renderBearData, handleFormSubmission, } from './ui';
const title = 'List_of_ursids';
export const extractBearData = async (wikitext) => {
    ...
    for (const table of speciesTables) {
        ...
        for (const row of rows) {
            ...
            if (nameMatch !== null && binomialMatch !== null && imageMatch !== null) {
                const rawRange = rangeMatch !== null && rangeMatch[1]?.trim() !== ''
                    ? rangeMatch[1].trim()
